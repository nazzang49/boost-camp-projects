...
class Preprocess():
    ...
    def __init__(self, sents: list, langs: list):
        self.sents = sents
        self.langs = langs
        ...
        for lang in langs:
            ...
            if lang not in Preprocess.PERMIT_REMOVE_LANGS:
                raise ValueError('[ Not Removable Lang ] 제거 대상에 포함되지 않는 언어입니다.')
        ...
        print(self.ord_list) # unicode range

    def _proc_preprocessing(self):
        """
